...
export const SpmtDocument: React.FC<SpmtDocumentProps> = ({ employee, settings }) => {
  return (
    <div className="bg-white p-6 max-w-[210mm] mx-auto text-justify text-black print:p-0 print:max-w-none print:w-full print:mx-0 leading-tight font-sans">
      
      {/* KOP SURAT - Diluar class spmt-font agar ukuran tetap */}
      ...
      {/* BODY CONTENT - Menggunakan spmt-font (12pt) */}
      <div className="spmt-font">
          {/* JUDUL */}
          ...
          <div className="mb-2 text-justify">
            <p className="indent-8 leading-relaxed">
              telah secara nyata melaksanakan tugas sejak tanggal <strong>0{formatDateIndonesian(employee.spmtDate)}</strong> pada {employee.placementUnit || '.............................................'} Sekretariat Daerah Kabupaten Demak.
            </p>
          ...
          <div className="flex justify-end mt-10 mb-8 break-inside-avoid text-left">
             <div className="w-[380px]">
                ...
                <p className="pl-12 mb-0.5">Ditetapkan di Demak</p>
