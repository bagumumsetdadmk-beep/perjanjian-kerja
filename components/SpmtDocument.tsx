              ...
              <table className="w-full">
                <tbody>
                  <tr>
                    ...
                    <td className="w-[230px] align-top">Nama</td>
              ...
              <table className="w-full">
                   <tbody>
                      <tr>
                        ...
                        <td className="w-[206px] align-top">Pejabat yang mengangkat</td>
                        <td className="w-4 align-top">:</td>
                      ...
                      <tr>
                        ...
                        <td className="align-top">:</td>
                        <td className="align-top">1 Oktober 2025 sampai dengan 30 September 2026</td>
                      </tr>
                   </tbody>
              </table>
            </div>
